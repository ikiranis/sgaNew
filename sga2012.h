...
#define NVARS           8       /* Number of problem variables      */
#define PXOVER          0.25     /* Probability of crossover         */
#define PMUTATION       0.10    /* Probability of mutation     	    */
#define TRUE            1
#define FALSE           0
#define ANTIGENPOPSIZE  10000    /* Number of antigens               */
